    ...
    imprimirCitas({citas}) {
        ...
        citas.forEach(cita => {
            ...
            fechaParrafo.innerHTML = `
                <span class='font-weight-bolder'>Tel: </span>${fecha}
            `;
